  ...
  return (
    ...
    >
      <NavigationMenuList className="max-w-full overflow-x-auto justify-start no-scrollbar mr-12">
        <Link
          className={cn(navigationMenuTriggerStyle(), "group font-semibold hover:text-[rgb(16,91,171)]")}
          href="/"
        >
          Нүүр
        </Link>
        ...
        <Link
          className={cn(navigationMenuTriggerStyle(), "group font-semibold ml-5 hover:text-[rgb(16,91,171)]")}
          href="/about"
        >
          Бидний тухай
        </Link>
                        ...
                        <ul className="text-[#4a4a4a] text-sm mt-3">
                          {childrenCats.map((cat) => (
                            <li key={cat._id} className="py-2 hover:bg-gray-100 rounded-md transition duration-50">
                              <Link
                                className="px-2 py-1 block hover:text-[rgb(16,91,171)]"
                                href={{
                                  pathname: "/category",
