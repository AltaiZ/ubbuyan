  ...
  return (
    ...
    >
        ...
        <div className="col-md-4">
          ...
          <div id="form_container_1">
            ...
            >
              ...
              <p>
                <label>Нэр</label>
                <input name="form_field_1" type="text" />
              </p>
              <p></p>
              <p>
                <label>Утасны дугаар</label>
                <input name="form_field_2" type="text" />
              </p>
              <p></p>
              <p>
                <label>И-мэйл хаяг</label>
                <input name="form_field_3" type="text" />
              </p>
              <p></p>
              <p>
                <label>Текст</label>
                <textarea name="form_field_4" />
              </p>
              <p>
                <button type="submit">Явуулах</button>
              </p>
            </form>
            <script
              dangerouslySetInnerHTML={{
                __html:
                  "        $(document).ready(function(){            nm.ajaxForm('#form_id_1', {                success: function(res){                    if (res.is_valid == 'true'){                        res.redirect_url ? location.href = res.redirect_url: $('#form_container_1').html(res.content);                    }else{                        $('#form_id_1 .errors').html(res.errors);                    };                },            });        });    ",
              }}
            />
          </div>
          <p />
      ...
      <div className="map_box container">
        <div className="map_news np col-md-5 col-xs-12">
          <div className="col-md-12 contact_box">
            <div className="">
              <li>
                <svg
                  aria-hidden="true"
                  className="svg-inline--fa fa-phone fa-w-16 col-md-3 contact fa-lg"
                  data-fa-i2svg=""
                  data-icon="phone"
                  data-prefix="fa"
                  role="img"
                ...
                <p className="col-md-9">(+976)7016-2222</p>
              </li>
              <li>
                <svg
                  aria-hidden="true"
                  className="svg-inline--fa fa-envelope fa-w-16 col-md-3 contact fa-lg"
                  data-fa-i2svg=""
                  data-icon="envelope"
                  data-prefix="fa"
                  role="img"
                ...
                <p className="col-md-9">info@ubbuyan.mn</p>
              </li>
            </div>
          </div>
        </div>
      ...
      >
        ...
        >
          ...
          <div
            aria-describedby="65162950-A19D-49CF-92C9-FD99FF1DF2B8"
            aria-label="Map"
          ...
          >
            <div
              id="65162950-A19D-49CF-92C9-FD99FF1DF2B8"
              style={{
                display: "none",
              }}
            >
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <span
                      id="DE62E402-6163-4C6B-AFD5-D57E3CB58FE6"
                      style={{
                        display: "none",
                      }}
                    >
                    ...
                    <div
                      aria-describedby="DE62E402-6163-4C6B-AFD5-D57E3CB58FE6"
              ...
              >
                ...
                >
                  <button
                    ...
                    draggable="false"
                    id="FEAC3DC0-DD8C-4B39-9DC2-605D01C9CD05"
                    role="menuitemradio"
                    style={{
                      appearance: "none",
                  ...
                  <ul
                    aria-labelledby="FEAC3DC0-DD8C-4B39-9DC2-605D01C9CD05"
                    role="menu"
                    style={{
                ...
                >
                  <button
                    ...
                    draggable="false"
                    id="979C563C-0D03-408C-BA29-456AD658FACF"
                    role="menuitemradio"
                    style={{
                      appearance: "none",
                      background: "none padding-box rgb(255, 255, 255)",
                  ...
                  <ul
                    aria-labelledby="979C563C-0D03-408C-BA29-456AD658FACF"
                    role="menu"
                    style={{
                      backgroundColor: "white",
                      borderBottomLeftRadius: "2px",
            ...
            <div>
              ...
              >
                ...
                <button
                  aria-describedby="260E7E5F-56C4-49D7-9071-469F8B5C031D"
                ...
                >
                  ...
                  <span
                    id="260E7E5F-56C4-49D7-9071-469F8B5C031D"
                    style={{
                      display: "none",
                    }}
                  >
