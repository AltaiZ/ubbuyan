    ...
    >
      <section className="page_complex container">
        <div className="col-md-6 tsogtsolbor">
          <article className="hide-gallery">
            <header>
              <h2 className="nm sub_title">Дурсгалын цэцэрлэгт хүрээлэн</h2>
            </header>
            <p className="text hide-gallery jy no_img"></p>
            <p>
              "Нью семетри" ХХК-ийн Дурсгалын цэцэрлэгт хүрээлэннь бурхан
            ...
            <p>
              Дурсгалын цэцэрлэгт хүрээлэн нь Сонгино Хайрхан Дүүргийн нутаг
              дэвсгэр "Шүлэг уул"-ынэнгэрт байрладаг.{" "}
            </p>
            <p />
            <figure />
            <p />
      ...
      >
        ...
        >
          ...
          <div
            aria-describedby="D072D9AA-06DC-4377-B2C5-50DBB3D6ACA1"
            aria-label="Map"
          ...
          >
            <div
              id="D072D9AA-06DC-4377-B2C5-50DBB3D6ACA1"
              style={{
                display: "none",
              }}
            >
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <span
                      id="77EDE85F-FA7C-483A-B423-08974FF91DE7"
                      style={{
                        display: "none",
                      }}
                    >
                    ...
                    <div
                      aria-describedby="77EDE85F-FA7C-483A-B423-08974FF91DE7"
              ...
              >
                <p className="gm-style-mot">Use ⌘ + scroll to zoom the map</p>
              </div>
            </div>
            <iframe
              aria-hidden="true"
              ...
              >
                ...
                >
                  <button
                    ...
                    draggable="false"
                    id="6490939F-ADAE-4890-A2D2-FBDB16135C80"
                    role="menuitemradio"
                    style={{
                      appearance: "none",
                  ...
                  <ul
                    aria-labelledby="6490939F-ADAE-4890-A2D2-FBDB16135C80"
                    role="menu"
                    style={{
                ...
                >
                  <button
                    ...
                    draggable="false"
                    id="D9925A7F-26C8-44FD-A35B-0434733AD509"
                    role="menuitemradio"
                    style={{
                      appearance: "none",
                      background: "none padding-box rgb(255, 255, 255)",
                  ...
                  <ul
                    aria-labelledby="D9925A7F-26C8-44FD-A35B-0434733AD509"
                    role="menu"
                    style={{
                      backgroundColor: "white",
                      borderBottomLeftRadius: "2px",
            ...
            <div>
              ...
              >
                ...
                <button
                  aria-describedby="6D29E27E-70EF-4881-84A0-551A35F17E72"
                ...
                >
                  ...
                  <span
                    id="6D29E27E-70EF-4881-84A0-551A35F17E72"
                    style={{
                      display: "none",
                    }}
                  >
