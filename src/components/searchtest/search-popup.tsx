  ...
  return (
    <Popover open={open} onOpenChange={setOpen} modal>
      <PopoverTrigger asChild className="bg-black">
        <div
          className={cn("fixed", isScrolled ? "top-[100px]" : "top-[100px]")}
        />
      </PopoverTrigger>
      <PopoverContent
        className="w-screen border-b-0 border-x-0 px-0 rounded-b-lg drop-shadow-xl"
        sideOffset={0}
      >
              ...
              <div className="flex items-center justify-between border-b pb-3 mb-4 font-medium text-sm">
                ...
                <Button variant="ghost" asChild>
                  ...
                  >
                    <MoveRight
                      strokeWidth={1.5}
                      className="stroke-[rgb(16,91,171)]"
                    />
                  </Link>
                </Button>
              </div>
