                    ...
                    <div className="garchig">
                      ...
                      <h4>
                        <a
                          ...
                          title="Бүх төрлийн БУЯНЫ ЗЭД-г онлайнаар..."
                        >
                          Бүх төрлийн БУЯНЫ ЗЭД-г онлайнаар...
                        </a>
                      </h4>
                    </div>
                  </div>
                    ...
                    <div className="garchig">
                      ...
                      <h4>
                        <a
                          ...
                          title="Бурхан бологсдыг дурсах олон улсын өдрийг 6 дахь жилдээ зохион байгууллаа"
                        >
                          Бурхан бологсдыг дурсах олон улсын өдрийг 6 дахь
                          жилдээ зохион байгууллаа
                        </a>
                      </h4>
                    </div>
                  </div>
                    ...
                    <div className="garchig">
                      ...
                      <h4>
                        ...
                        >
                          ...
                          байгууллагын үзүүлэх нөлөө, шийдвэрлэх арга хэмжээний
                          талаар нээлттэй хэлэлцүүлэг боллоо
                        </a>
                      </h4>
                    </div>
                  </div>
                    ...
                    <div className="garchig">
                      ...
                      <h4>
                        <a
                          ...
                          title="БИД ДЭЛХИЙН ХӨГЖЛИЙН ТҮҮЧЭЭ IX - семинар"
                        >
                          БИД ДЭЛХИЙН ХӨГЖЛИЙН ТҮҮЧЭЭ IX - семинар
                        </a>
                      </h4>
                    </div>
                  </div>
                    ...
                    <div className="garchig">
                      ...
                      <h4>
                        <a
                          ...
                          title="Бурхан бологсодыг дурсах олон улсын өдөр  2021.09.19"
                        >
                          Бурхан бологсодыг дурсах олон улсын өдөр 2021.09.19
                        </a>
                      </h4>
                    </div>
                  </div>
                    ...
                    <div className="garchig">
                      ...
                      <h4>
                        <a
                          ...
                          title="Самбалхүндэвийн оршуулгын газарт “Дурсгалын цэцэрлэгт хүрээлэн” байгуулахыг дэмжив"
                        >
                          Самбалхүндэвийн оршуулгын газарт “Дурсгалын цэцэрлэгт
                          хүрээлэн” байгуулахыг дэмжив
                        </a>
                      </h4>
                    </div>
                  </div>
